...
def manipulateBorderArray(data, cropSize):
	...
	crop_botfrom skimage import img_as_floattom = data[h-cropSize:h,0:w,:]
	...
	data_bofrom skimage import img_as_floatrder[h+mask:h+mask+mask, w+mask:w+mask+mask, :] = flipped_bottom[0:mask, w-mask:w ,:]
