...
#ate 2 no 41
#1
python /media/tensorflow/applications/subimages_6x3.py /media/tensorflow/coffee/dataset/ /media/tensorflow/coffee/output/ 8_5,9_6,7_7,7_6,7_5,8_7 7_7 8_6,9_7,9_5 17 0.001 0.005 1000 0 10 1 1 0 0 3 0 1
#2
